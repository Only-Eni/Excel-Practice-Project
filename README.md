...
- Bike_Sales_Dashboard.xlsx 
  (Excel dashboard with pivot tables and slicers)<img width="1344" height="605" alt="Screenshot 2026-02-12 133950" src="https://github.com/user-attachments/assets/4ba134a1-bd64-4ef1-8b9d-28dcdf181a26" />

-  Dataset (cleaned dataset used for analysis)
   [DATA PRACTICE ON BIKE SALES.xlsx](https://github.com/user-attachments/files/25262506/DATA.PRACTICE.ON.BIKE.SALES.xlsx)
